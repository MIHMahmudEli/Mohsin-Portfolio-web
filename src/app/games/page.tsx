      ...
      <div className="relative py-16 md:py-24">
        <div className="max-w-6xl mx-auto px-6">
                ...
                >
                  ...
                  >
                    ...
                    <div className="relative p-5 flex flex-col h-full">
                      ...
                      <h3 className="text-base font-semibold text-content mb-2 group-hover:text-emerald-300 transition-colors duration-200">{g.title}</h3>
                      <p className="text-xs text-muted leading-relaxed mb-5 line-clamp-2 group-hover:text-subtle transition-colors duration-200 flex-1">{g.desc}</p>
                      ...
                      >
                        ...
                        {g.githubUrl && (
                          <motion.a
                            ...
                            className="inline-flex items-center gap-1.5 text-[11px] text-muted hover:text-content transition-colors"
                            whileHover={{ x: 2 }}
                          >
          ...
          <motion.div
            ...
            className="mt-12 p-6 rounded-2xl border border-line bg-card/20 flex items-center justify-between flex-wrap gap-4 relative overflow-hidden group"
            whileHover={{ y: -2 }}
          >
            <motion.div
