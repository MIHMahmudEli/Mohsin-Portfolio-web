      ...
      <div className="relative py-16 md:py-24">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            {games.map((g, i) => {
              ...
              return (
                ...
                >
                  <div
                    className={`group relative rounded-2xl border border-zinc-800 overflow-hidden h-full transition-shadow duration-300 ${
                      g.featured ? 'bg-zinc-900/50' : 'bg-zinc-900/30'
                    }`}
                    style={{
                  ...
                  >
                    ...
                    <div className="relative p-5 flex flex-col h-full">
                      <div className="flex items-start justify-between mb-4">
                        <motion.div
                          className="w-12 h-12 rounded-2xl flex items-center justify-center text-2xl bg-zinc-900/60 border border-zinc-700/50 emoji-bob"
                      ...
                      <h3 className="text-base font-semibold text-white mb-2 group-hover:text-emerald-300 transition-colors duration-200">{g.title}</h3>
                      <p className="text-xs text-zinc-500 leading-relaxed mb-5 line-clamp-2 group-hover:text-zinc-400 transition-colors duration-200 flex-1">{g.desc}</p>
          ...
          <motion.div
            ...
            className="mt-12 p-6 rounded-2xl border border-zinc-800 bg-zinc-900/20 flex items-center justify-between flex-wrap gap-4 relative overflow-hidden group"
            whileHover={{ y: -2 }}
          >
            <motion.div
            ...
            <Link
              href="/projects"
              className="relative px-5 py-2.5 border border-zinc-700 text-zinc-300 rounded-full text-xs font-medium hover:bg-zinc-800 hover:border-zinc-500 transition-colors"
            >
              View all projects
            </Link>
          </motion.div>
